    ...
    return (
        <section ref={sectionRef} className='pt-0 relative bg-white  lg:mb-0 overflow-hidden'>
            ...
            <div className='flex  h-full  lg:pb-0 px-5 flex-col lg:flex-row'>
                ...
                >
                    <div className="hidden aspect-3-4 shrink-0 w-2/5 absolute inset-0 m-auto bg-blue-200 rounded-2xl"></div>
                    <div className="shadow-black shadow-2xl overflow-hidden aspect-3-4 shrink-0 w-5/12 md:w-4/12 lg:w-4/12 absolute inset-0 m-auto bottom-80 md:bottom-96 lg:bottom-80 right-96 bg-violet-400 rounded-2xl">
                        <Image alt='' src={img4} className='object-cover h-full w-full' />
                    </div>
                    <div className="shadow-black shadow-2xl overflow-hidden aspect-3-4 shrink-0 w-6/12 md:w-5/12 lg:w-3/11 absolute inset-0 m-auto bg-green-300 left-44 md:left-96 lg:left-80 bottom-60 rounded-2xl">
                        <Image alt='' src={img2} className='object-cover h-full w-full' />
                    </div>
                    <div className="shadow-black shadow-2xl overflow-hidden aspect-3-4 shrink-0 w-6/12 md:w-6/12 lg:w-3/12 absolute inset-0 top-80 md:top-96 lg:top-80 right-80 md:right-96 lg:right-80 m-auto rounded-2xl">
                        <Image alt='' src={img3} className='object-cover h-full w-full' />
                    </div>
                    <div className="aspect-3-4 shrink-0 w-8/12 md:w-7/12 lg:w-5/12 absolute inset-0 m-auto bg-blue-200 rounded-2xl overflow-hidden shadow-black shadow-2xl">
